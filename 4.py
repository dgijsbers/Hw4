...
## SI 206 - W17 - HW4
## COMMENT WITH:
## Your section day/time: Section 003, Thursday 6-7
...
## The strings that should be elements of your lists will be different depending upon when you accessed 
# the data, but they should probably be somewhat like this:
...
## Weed out the headlines that do not have any text, for instance the headlines that are linked to pictures
# or video but without any text content. You should not add these to the list nor count them towards the limit 
#of 10. Ignore them completely.
...
## We have included a couple of unit tests to check some things about your result, but we will also be checking
# your code against our OWN version of a nytimes_data.html file, which will almost certainly be different from 
#yours, and your code should still work to get the first 10 text headlines from our file!

## Write your code to complete this task here.
## HINT: Remember that you'll need to open the file you created in Part 1, read the contets into one big string, 
...
## Use the requests library (or other Python code that has the same effect) and Beautiful Soup to gather, from that 
#web page, each of the names and the titles.
## You should create a dictionary called umsi_titles which contains the names and the titles for each person on 
#that page. For example, your dictionary should include the following key-value pairs (and a bunch more...):

## "Lindsay Blackwell":"PhD Student"
## "Reginald Beasley":"Admissions and Student Affairs Assistant"
## "Daniel Atkins III":"Professor Emeritus of Information, School of Information and Professor Emeritus of Electrical
...
## Write code to complete this task here. We've gotten you started... note that it'll be difficult to continue if you 
# don't understand what the provided code does!
